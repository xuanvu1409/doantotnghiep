...
router.post('/profile/upload-avatar', auth, uploadSingle, profileController.uploadAvatar);
...
router.get('/profile/get-gallery', auth, profileController.getGallery);
router.delete('/profile/remove-image/:_id', auth, profileController.removeImage);
router.get('/profile/set-avatar', auth, profileController.setAvatarbyId);
...
router.put('/profile/change-status-contact', auth, profileController.changeStatusContact);
router.put('/profile/get-contact', auth, profileController.getContactByMemberId);
router.get('/profile/get-contact-not-hidden', auth, profileController.getContactNotHidden);
