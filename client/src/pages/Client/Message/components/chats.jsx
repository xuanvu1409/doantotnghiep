...
const Chats = (props) => {
    const {messages, me, toMember, sendMessage, errMatched, files, setFiles, isSubmiting} = props;
                                ...
                                <div className="col-3 col-xl-6 text-right">
                                    <ul className="nav justify-content-end">
                                        <li className="nav-item list-inline-item d-none d-xl-block mr-3">
                                            <span className="nav-link text-muted px-3" title="Search this chat">
                                                <i className="icon-md tio-video-camera"/>
                                            </span>
                                        </li>
                                        <li className="nav-item list-inline-item d-none d-xl-block mr-3">
                                            <a className="nav-link text-muted px-3" data-toggle="collapse"
                                               data-target="#chat-2-search" href="#" title="Search this chat">
                                                <i className="icon-md tio-search"/>
                                            </a>
                                        </li>
                                        ...
                                        {/*        <i className="icon-md tio-more-vertical"/>*/}
                                        {/*    </a>*/}
                                        {/*</li>*/}
                                        {/* Mobile nav */}
                                ...
                                <form id="chat-id-2-form"
                                    ...
                                    <div className="form-row align-items-center">
                                        <div className="col">
                                            <div className="input-group">
                                                {/* Textarea */}
                                                <textarea id="chat-input" {...register('content', {required: files.length === 0 })}
                                        ...
                                        <div className="col-auto">
                                            {
                                                ...
                                                ?
                                                    ...
                                                    :
                                                    <button className="btn icon-shape btn-primary rounded-circle"
                                                            type="submit">
