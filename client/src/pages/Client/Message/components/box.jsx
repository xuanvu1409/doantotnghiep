...
const Box = (props) => {
    const {data, loadMessage, getThread, toMember, me} = props;
    const {messageThread, relationship} = data;
                        ...
                        <div className="text-center hide-scrollbar d-flex my-4" data-horizontal-scroll={true}>
                            {
                                relationship.map(e => (
                                    ...
                                    <span className="d-block text-reset mr-5 mr-lg-4" key={e._id}>
                                        <div className="avatar mb-2 avatar-circle" onClick={() => loadMessage(e.relatedId._id)}>
                                            <img className="avatar-img" src={e.relatedId?.avatar.srcImage}
                                        ...
                                        :
                                        <span className="d-block text-reset mr-5 mr-lg-4" key={e._id}>
                                        <div className="avatar mb-2 avatar-circle" onClick={() => loadMessage(e.relatingId._id)}>
                                            <img className="avatar-img" src={e.relatingId?.avatar.srcImage}
                                                 alt="Image Description"/>
                                            {
                                                e.relatingId.role
                                                &&
